...
import clearInputHandlerAction from '../actions/clearInputs';
import addExpensesIndexAction from '../actions/addExpenseIndex';
...
class BtnAddExpense extends Component {
  constructor() {
    super();
...
export default connect(mapStateToProps, mapDispatchToProps)(BtnAddExpense);
